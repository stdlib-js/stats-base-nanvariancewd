...
```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanvariancewd@deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-nanvariancewd/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-base-nanvariancewd/actions/workflows/test.yml?query=branch:main
